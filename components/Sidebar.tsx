    ...
    { section: "Keuangan", items: [
      {
        ...
        group: "/keuangan",
        children: [
          { href: "/keuangan/ringkasan", label: "Ringkasan Keuangan" },
          ...
          { href: "/keuangan/pph-report", label: "PPh Report" },
          { href: "/keuangan/ppn-report", label: "PPN Report" },
          { href: "/keuangan/dana", label: "Dana Masuk / Keluar" },
          { href: "/keuangan/invoice", label: "Invoice & Kwitansi" },
          { href: "/keuangan/coa", label: "Chart of Accounts" },
          { href: "/keuangan/jurnal-umum", label: "Jurnal Umum" },
          { href: "/keuangan/aset-tetap", label: "Aset Tetap" },
          { href: "/keuangan/rekonsiliasi", label: "Rekonsiliasi Bank" },
          { href: "/keuangan/anggaran", label: "Anggaran vs Realisasi" },
        ],
      },
    ]},
